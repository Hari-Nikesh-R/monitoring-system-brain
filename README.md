...
4. **Storage** — Status snapshots and alerts are written to a local SQLite database (`cattle_monitoring.db`).
5. **Dashboard** — Streamlit renders the annotated video, a live status table, aggregate metrics, and an alert log.
